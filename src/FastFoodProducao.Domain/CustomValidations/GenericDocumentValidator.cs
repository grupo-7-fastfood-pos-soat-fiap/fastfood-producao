...
namespace FastFoodProducao.Domain.CustomValidations
{
    ...
    public abstract class GenericDocumentValidator<T, TProperty> : PropertyValidator<T, TProperty>, ICustomPropertyValidator
    {
        ...
        protected GenericDocumentValidator(int validLength, string errorMessage)
        {
